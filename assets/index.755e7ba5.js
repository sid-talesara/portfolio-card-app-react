  ...
  function E(C, P) {
    ...
    try {
      ...
      if (m !== null) var er = !0;
        ...
        var vn = t(c);
        vn !== null && gl(v, vn.startTime - P), (er = !1);
      }
      return er;
    } finally {
      (m = null), (p = z), (g = !1);
...
function Tc(e, n, t, r, l, o, i, u, s) {
  (Ct = !1), (Or = null), zc.apply(Lc, arguments);
}
...
function ks(e) {
  return (e = Oc(e)), e !== null ? Ss(e) : null;
}
function Ss(e) {
...
var Re = Math.clz32 ? Math.clz32 : Ac,
  Uc = Math.log,
  $c = Math.LN2;
function Ac(e) {
...
function ei(e, n, t, r) {
  if (Fr) {
    ...
    else if ((Gi(e, r), n & 4 && -1 < Wc.indexOf(e))) {
      for (; l !== null; ) {
        var o = qt(l);
        if (
          (o !== null && Ps(o),
...
var it = {
  ...
  Jc = we(Zc),
  qc = V({}, Jt, { relatedTarget: 0 }),
  zl = we(qc),
  bc = V({}, it, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ef = we(bc),
  nf = V({}, it, {
...
var af = V({}, Jt, {
  ...
  pf = we(df),
  mf = V({}, it, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  hf = we(mf),
  vf = V({}, tl, {
    deltaX: function (e) {
...
var wf = We && "TextEvent" in window && !_t,
  Ds = We && (!li || (_t && 8 < _t && 11 >= _t)),
...
function $s(e) {
  if (e.propertyName === "value" && rl(jt)) {
    var n = [];
    js(n, jt, e, Zo(e)), gs(Cf, n);
  }
}
function xf(e, n, t) {
  e === "focusin"
    ? (ou(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", $s))
    : e === "focusout" && ou();
}
function Nf(e) {
...
for (var Ol = 0; Ol < au.length; Ol++) {
  var Ml = au[Ol],
    Of = Ml.toLowerCase(),
    Mf = Ml[0].toUpperCase() + Ml.slice(1);
  pn(Of, "on" + Mf);
}
...
function hn() {
  if (!jl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), Es(Jo, hn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function oa(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (N === d.length) return t(f, x), U && gn(f, N), E;
    if (x === null) {
      for (; N < d.length; N++)
        (x = m(f, d[N], v)),
          x !== null &&
  ...
  function k(f, a, d, v) {
    ...
    if (T.done) return t(f, x), U && gn(f, N), E;
    if (x === null) {
...
function Ea(e, n, t) {
  return (zn & 21) === 0
    ...
    : (Me(t, n) || ((t = xs()), (A.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n);
}
function Qf(e, n) {
  var t = O;
...
function ld(e, n) {
  ...
  for (vo = { focusedElem: e, selectionRange: t }, Fr = !1, S = n; S !== null; )
...
function Ua(e) {
  ...
  n !== null && ((e.alternate = null), Ua(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[wo], delete n[Af], delete n[Vf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = xi + 500 - Q()), 10 < n))
          ) {
            if (Ir(e, 0) !== 0) break;
...
function br(e, n) {
  ...
  while (1);
  if ((ci(), (R = t), (Zr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), X;
}
function sd() {
  for (; K !== null; ) Ka(K);
...
function fd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - xi)
        ? Cn(e, 0)
        : (_i |= t)),
    pe(e, n);
}
...
Ga = function (e, n, t) {
  ...
  else (ce = !1), U && (n.flags & 1048576) !== 0 && qs(n, Hr, n.index);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), pe(n, Q()), (R & 6) === 0 && ((lt = Q() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
vs = Ni;
ys = Tn;
var kd = { usingClientEntryPoint: !1, Events: [qt, $n, ol, ms, hs, Ni] },
  yt = {
...
const j = Di.exports.jsx,
  xn = Di.exports.jsxs;
function zd() {
  return xn("div", {
    className: "other-details",
    children: [
      j("h2", { className: "about", children: "About" }),
      j("p", {
        className: "about-desc",
        children:
          "A creative designer, tech enthusiast, web-developer and gardner. Exploring the world of possibliities\u{1F680}",
      }),
      j("h2", { className: "interests", children: "Interests" }),
      j("p", {
...
function Ld() {
  return xn("div", {
    ...
    children: [
      j("h1", { className: "name", children: "Sid Talesara" }),
      j("h5", { className: "profession", children: "Web Developer" }),
      j("p", { className: "email-address", children: "sidtalesara@gmail.com" }),
      xn("button", {
        className: "email-btn",
        children: [j("i", { class: "fa-solid fa-envelope" }), " Email"],
      }),
      xn("button", {
        className: "linkedin-btn",
        children: [j("i", { class: "fa-brands fa-linkedin" }), " Linkedin"],
      }),
    ],
  });
}
  ...
  return xn("div", {
    ...
    children: [
      j("a", {
        ...
        children: j("i", { class: "fa-brands fa-square-twitter footer-icon" }),
      }),
      j("a", {
        href: "http://facebook.com/sidtalesara",
        target: "_blank",
        rel: "noopener noreferrer",
        children: j("i", { class: "fa-brands fa-square-facebook footer-icon" }),
      }),
      j("a", {
        href: "http://instagram.com/sidtalesara",
        target: "_blank",
        rel: "noopener noreferrer",
        children: j("i", {
          class: "fa-brands fa-square-instagram footer-icon",
        }),
      }),
      j("a", {
        href: "http://github.com/sid-talesara",
        target: "_blank",
        rel: "noopener noreferrer",
        children: j("i", { class: "fa-brands fa-square-github footer-icon" }),
      }),
    ],
  });
}
function Od() {
  return (
    Xt.exports.useState(0),
    xn("div", {
      className: "Container",
      children: [
        j("img", {
          src: "https://i.imgur.com/LVFbonp.png",
          alt: "",
